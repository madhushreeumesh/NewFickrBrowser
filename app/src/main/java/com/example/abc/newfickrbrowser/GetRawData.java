...
class GetRawData extends AsyncTask<String, Void , String> {
    ...
    protected void onPostExecute(String s) {
        // Log.e(TAG, "onPostExecute: Parameter: " + s );
        if (mCallback != null){
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            Log.e(TAG, "doInBackground: IO Execption reading data :" + e.getMessage() );
        } catch (SecurityException e){
            Log.e(TAG, "doInBackground: Secutity Exeption , Need permission ?" + e.getMessage() );
        } finally {
            if(connection !=null){
